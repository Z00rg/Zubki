      ...
      <header className="bg-gradient-to-r from-blue-600 to-indigo-700 shadow-lg">
        <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8 flex justify-between items-center">
          <div>
            ...
            <p className="text-blue-200 text-sm mt-1">Система автоматизированного проектирования</p>
          </div>
        ...
        <div className="flex gap-6">
          ...
          <div className="w-1/4 bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-200/50 p-4">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-semibold text-gray-800">Список пациентов</h2>
          ...
          <div className="w-3/4 space-y-6">
            ...
            {selectedPatient && (
              <div className="bg-gradient-to-r from-white to-gray-50 p-6 rounded-xl shadow-lg border border-gray-200/50">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-xl font-semibold text-gray-800">Карточка пациента</h2>
            ...
            {selectedPatient && (
              <div className="bg-gradient-to-r from-white to-gray-50 p-6 rounded-xl shadow-lg border border-gray-200/50">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-xl font-semibold text-gray-800">Снимки КТ/МРТ</h2>
                  <div className="flex space-x-2">
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="flex-1">
                    <div className="bg-gradient-to-br from-gray-800 to-gray-900 border-2 border-dashed border-gray-700/50 rounded-xl w-full h-96 flex items-center justify-center relative overflow-hidden">
                      ...
                      <div className="text-center z-10">
                        <div className="text-gray-300 mb-2 text-lg font-medium">Снимок КТ/МРТ</div>
                  ...
                  {/* Image thumbnails */}
                  <div className="w-32">
                    <h3 className="text-sm font-medium mb-2 text-gray-700">Все снимки</h3>
            ...
            {selectedPatient && implantParams && (
              <div className="bg-gradient-to-r from-white to-gray-50 p-6 rounded-xl shadow-lg border border-gray-200/50">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-xl font-semibold text-gray-800">САПР имплантата</h2>
                  <div className="flex space-x-2">
                  ...
                  <div>
                    <div className="bg-white p-5 rounded-xl border border-gray-200/50 shadow-sm">
                      ...
                      <div className="bg-gradient-to-br from-gray-900 to-black border-2 border-dashed border-gray-700/50 rounded-xl w-full h-64 flex items-center justify-center relative overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-br from-blue-900/10 to-purple-900/10"></div>
                        <div className="text-center z-10">
                          <div className="text-gray-300 mb-2 text-lg font-medium">3D модель имплантата</div>
                          <div className="text-sm text-gray-400">
              ...
              <div className="bg-gradient-to-br from-white to-blue-50 p-10 rounded-xl shadow-lg text-center border border-gray-200/50">
                <div className="max-w-md mx-auto">
                  ...
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    Выберите пациента из списка слева для начала работы. Система автоматически рассчитает оптимальные параметры дентального имплантата на основе данных компьютерной томографии.
                  </p>
                  <div className="inline-flex items-center text-blue-600 font-medium">
                    <span>Выберите пациента</span>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-1 animate-pulse" viewBox="0 0 20 20" fill="currentColor">
